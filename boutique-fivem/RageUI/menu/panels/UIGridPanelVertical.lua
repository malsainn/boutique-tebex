...
function RageUI.GridPanelVertical(Y, TopText, BottomText, Callback, Index)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            CircleX = CircleX + ((GridPanelVertical.Grid.Width - 20) * X) - (GridPanelVertical.Circle.Width / 2)
            CircleY = CircleY + ((GridPanelVertical.Grid.Height - 20) * Y) - (GridPanelVertical.Circle.Height / 2)
