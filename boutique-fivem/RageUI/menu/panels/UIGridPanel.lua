local Grid = {
    ...
    Text = {
        Top = { X = 215.5, Y = 15, Scale = 0.20 },
        Bottom = { X = 215.5, Y = 250, Scale = 0.20 },
        Left = { X = 57.75, Y = 130, Scale = 0.20 },
        Right = { X = 373.25, Y = 130, Scale = 0.20 },
    },
}
        ...
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            if Hovered then
                if IsDisabledControlPressed(0, 24) then
                    ...
                    if CircleY > (CurrentMenu.Y + Grid.Grid.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 20 + Grid.Grid.Height - 20) then
                        CircleY = CurrentMenu.Y + Grid.Grid.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 20 + Grid.Grid.Height - 20
                    ...
                    X = math.round((CircleX - (CurrentMenu.X + Grid.Grid.X + (CurrentMenu.WidthOffset / 2) + 20) + (Grid.Circle.Width / 2)) / (Grid.Grid.Width - 20), 2)
                    Y = math.round((CircleY - (CurrentMenu.Y + Grid.Grid.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 20) + (Grid.Circle.Height / 2)) / (Grid.Grid.Height - 20), 2)
